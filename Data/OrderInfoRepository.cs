...
namespace SfDataGridDemo
{
    public class OrderInfoRepository : INotifyPropertyChanged
    {
        ...
        /// <returns></returns>
        public ObservableCollection<OrderInfo> GetOrdersDetails(int count, bool isAddOrderDetails)
        {
            ObservableCollection<OrderInfo> ordersInfos = new ObservableCollection<OrderInfo>();
